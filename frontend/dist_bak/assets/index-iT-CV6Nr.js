const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/jspdf.es.min-BV6KcQi8.js","assets/typeof-e-75w6hn.js"])))=>i.map(i=>d[i]);
...
var API_ORIGIN$1 = "".replace(/\/+$/, "");
var TOKEN_KEY = "wageTracker.token";
function getToken() {
...
var REMEMBERED_EMAIL_KEY = "wageTracker.rememberedEmail";
...
async function request$1(path, options = {}) {
	const token = getToken();
	const headers = { "Content-Type": "application/json" };
	if (token) headers.Authorization = `Bearer ${token}`;
	let res;
	try {
		res = await fetch(`${API_ORIGIN$1}/api${path}`, {
			...options,
			headers: {
				...headers,
				...options.headers
...
function signup(input) {
	return request$1("/auth/signup", {
		method: "POST",
		body: JSON.stringify(input)
	});
}
function login(email, password) {
	return request$1("/auth/login", {
		method: "POST",
		body: JSON.stringify({
			email,
			password
...
function listShifts(from, to) {
	return request$1(`/shifts?from=${from}&to=${to}`);
}
function createShift(input) {
	return request$1("/shifts", {
		method: "POST",
		body: JSON.stringify(input)
	});
}
function patchShift(id, patch) {
	return request$1(`/shifts/${id}`, {
		method: "PATCH",
		body: JSON.stringify(patch)
	});
}
function deleteShift(id) {
	return request$1(`/shifts/${id}`, { method: "DELETE" });
}
//#endregion
...
function buildWeekDays(anchor, weekStartsOn) {
...
function formatTime12(hhmm) {
	...
	return `${h % 12 === 0 ? 12 : h % 12}:${pad2(m)} ${period}`;
}
...
function AppProvider({ children }) {
	...
	const [shiftsLoading, setShiftsLoading] = (0, import_react.useState)(false);
	const [shiftsLoaded, setShiftsLoaded] = (0, import_react.useState)(false);
	const [today, setToday] = (0, import_react.useState)(() => /* @__PURE__ */ new Date());
	(0, import_react.useEffect)(() => {
		const timer = setInterval(() => setToday(/* @__PURE__ */ new Date()), 6e4);
	...
	const reloadShifts = (0, import_react.useCallback)(async (u, anchor) => {
		setShiftsLoading(true);
		try {
			const cutoff = new Date(anchor.getFullYear() - 5, anchor.getMonth(), anchor.getDate());
			const weekEnd = addDays(startOfWeek(anchor, u.weekStartsOn), 6);
			const { shifts } = await listShifts(isoDate(cutoff), isoDate(weekEnd));
			setShifts(shifts);
		} finally {
	...
	(0, import_react.useEffect)(() => {
		if (status === "loggedIn" && user) reloadShifts(user, today);
	}, [
		status,
		user?.id,
		user?.weekStartsOn,
	...
	const login$1 = (0, import_react.useCallback)(async (email, password, remember = true) => {
		setAuthBusy(true);
		setAuthError(null);
		try {
	...
	const signup$1 = (0, import_react.useCallback)(async (input) => {
		setAuthBusy(true);
		setAuthError(null);
		try {
	...
	const deleteAccount$1 = (0, import_react.useCallback)(async (password) => {
	...
	const handleActionError = (0, import_react.useCallback)((e, fallback) => {
	...
	const createShift$1 = (0, import_react.useCallback)(async (input) => {
		try {
	...
	const updateShift = (0, import_react.useCallback)(async (id, patch) => {
		try {
			const { shift } = await patchShift(id, patch);
	...
	const removeShift = (0, import_react.useCallback)(async (id) => {
		try {
...
function HomeIcon({ size = 20 }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
		...
		...base,
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M4 11L12 4l8 7" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M6 10v9h12v-9" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M10 19v-5h4v5" })
		]
	});
}
function EntryIcon({ size = 20 }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
		width: size,
		height: size,
		viewBox: "0 0 24 24",
...
function ReportIcon({ size = 20 }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M6 19v-7" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M12 19V6" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M18 19v-10" })
		]
	});
}
...
function SettingsIcon({ size = 20 }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
		...
		...base,
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M4 6h9" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", {
				cx: "17",
				cy: "6",
				r: "2"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M20 12H9" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", {
				cx: "6",
				cy: "12",
				r: "2"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M4 18h9" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", {
				cx: "17",
				cy: "18",
				r: "2"
...
function EyeIcon({ size = 18 }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
		...
		viewBox: "0 0 24 24",
		...base,
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M2 12s3.8-7 10-7 10 7 10 7-3.8 7-10 7-10-7-10-7z" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", {
			cx: "12",
			cy: "12",
			r: "3"
		})]
...
function EyeOffIcon({ size = 18 }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
		...
		...base,
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M9.5 9.7a3 3 0 004.2 4.2" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M6.6 6.6C3.7 8.5 2 12 2 12s3.8 7 10 7a9.6 9.6 0 004.4-1" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M10.6 5.2A10.4 10.4 0 0112 5c6.2 0 10 7 10 7a16.5 16.5 0 01-3.5 4.3" }),
...
function BottomNav({ screen, onNavigate }) {
	const navStyle = {
		"--nav-index": Math.max(0, TABS.findIndex((t) => t.screen === screen)),
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: "app-bottomnav-indicator",
				"aria-hidden": "true"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "app-sidebar-brand",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Logo, { size: 22 }), "Wage Tracker"]
			}),
			TABS.map(({ screen: s, label, Icon }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				type: "button",
...
function useCountUp(target, durationMs = 650) {
	...
	const fromRef = (0, import_react.useRef)(target);
...
*/
function PasswordInput({ className = "input", ...props }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
			...
			className: `${className} input-password`
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
			type: "button",
			className: "password-toggle-btn",
			onClick: () => setVisible((v) => !v),
			"aria-label": visible ? "Hide password" : "Show password",
			children: visible ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EyeOffIcon, { size: 17 }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EyeIcon, { size: 17 })
		})]
	});
}
//#endregion
//#region src/components/AppCredit.tsx
/** Shared creator credit — shown on the auth screen and in Settings. */
function AppCredit() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "app-credit",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			className: "app-credit-name",
			children: "Built by Ezaz Ahmad"
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
			className: "app-credit-links",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
				className: "app-credit-link",
				href: "https://github.com/Ezaz-Ahmad",
				target: "_blank",
				rel: "noopener noreferrer",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(GithubIcon, { size: 13 }), "GitHub"]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
				className: "app-credit-link",
				href: "https://ezazahmad.com",
				target: "_blank",
				rel: "noopener noreferrer",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(GlobeIcon, { size: 13 }), "Portfolio"]
			})]
		})]
	});
}
//#endregion
//#region src/screens/AuthScreen.tsx
var FEATURES = [
	{
		icon: EntryIcon,
		title: "Clock in & out",
...
function LandingPreviewCard() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "landing-preview-card anim-rise",
		style: { ["--i"]: 10 },
		"aria-hidden": "true",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "landing-preview-kicker",
				children: "This week"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "landing-preview-amount count-value",
				children: ["$", fmt2$1(amount)]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "landing-preview-trend",
				children: "▲ 12% vs last week"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "progress-track landing-preview-track",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "landing-preview-caption count-value",
				children: [Math.round(progress), "% toward your weekly goal"]
			})
		]
	});
}
function AuthScreen() {
	...
	const [workLocationName, setWorkLocationName] = (0, import_react.useState)("");
	const [workAddress, setWorkAddress] = (0, import_react.useState)("");
	const [multipleLocations, setMultipleLocations] = (0, import_react.useState)(false);
	const [otherLocations, setOtherLocations] = (0, import_react.useState)("");
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "landing-shapes",
				"aria-hidden": "true",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "landing-shape landing-shape-1" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "landing-shape landing-shape-2" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "landing-shape landing-shape-3" })
				]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "landing-hero-content",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "landing-kicker anim-rise",
						style: { ["--i"]: 0 },
						children: "Wage Tracker"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h1", {
						className: "landing-headline anim-rise",
						style: { ["--i"]: 2 },
						children: [
							"Track your hours.",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "landing-subtext anim-rise",
						style: { ["--i"]: 4 },
						children: "Clock in, log shifts, and watch your weekly earnings add up — with goal tracking and PDF reports built in."
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "landing-features",
						children: FEATURES.map((f, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "landing-feature anim-rise",
							style: { ["--i"]: 6 + i },
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(LandingPreviewCard, {})
				]
			})]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "landing-auth-pane",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "auth-card",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h6", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Logo, { size: 20 }), "Wage Tracker"]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "seg landing-mode-toggle",
						...
						mode === "login" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "field field-spaced",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { children: "Password" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PasswordInput, {
										placeholder: "••••••••",
										value: password,
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "box" }),
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									...
									children: authBusy ? "Logging in…" : "Log in"
								})
							]
						}, "login") : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
							className: "anim-rise",
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "field field-spaced",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { children: "Work location name" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
										className: "input",
										type: "text",
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "field field-spaced",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { children: "Work address" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
										className: "input",
										type: "text",
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "field field-spaced",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { children: "Do you work multiple locations?" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "seg",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
											className: "seg-opt",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
												...
												onChange: () => setMultipleLocations(false)
											}), " No"]
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
											className: "seg-opt",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
												...
												name: "multiloc",
												checked: multipleLocations,
												onChange: () => setMultipleLocations(true)
											}), " Yes"]
										})]
									})]
								}),
								multipleLocations && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "field field-spaced",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { children: "Other locations" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
										className: "input",
										type: "text",
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									...
									disabled: authBusy,
									style: { justifyContent: "center" },
									children: authBusy ? "Creating account…" : "Create account"
								})
							]
						}, "signup"),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "auth-demo-note",
							children: "Your data is private to your account."
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppCredit, {})
					]
				})
			})
		})]
...
function buildDayComputed(date, shiftsForDate, isToday, currency, rate) {
	const raw = shiftsForDate.length ? shiftsForDate : [{
		id: "",
		date: isoDate(date),
		location: "",
		signIn: null,
	...
	const shifts = raw.map((sh, i) => {
		...
		return {
			...
			signOut: sh.signOut,
			hours,
			hoursLabel: hours > 0 ? `${fmt2$1(hours)}h` : "—",
			canRemove: raw.length > 1
		};
	});
	const hours = Math.round(shifts.reduce((a, s) => a + s.hours, 0) * 1e6) / 1e6;
	return {
		...
		hours,
		hoursLabel: hours > 0 ? `${fmt2$1(hours)}h` : "—",
		moneyLabel: hours > 0 ? currency + fmt2$1(hours * rate) : "—"
	};
}
function buildWeekDaysComputed(weekDays, shiftsByDate, today, currency, rate) {
...
function weekTotals(days, rate) {
	const hours = Math.round(days.reduce((a, d) => a + d.hours, 0) * 1e6) / 1e6;
	return {
		hours,
...
function buildShiftRows(days, currency, rate) {
	const rows = [];
	for (const d of days) for (const sh of d.shifts) {
		...
		rows.push({
			...
			moneyLabel: sh.hours > 0 ? currency + fmt2$1(sh.hours * rate) : "—"
		});
	}
	return rows;
}
function buildLocationBreakdown(rows) {
	...
	return Array.from(map.entries()).map(([location, v]) => ({
		location,
		hours: Math.round(v.hours * 1e6) / 1e6,
		hoursLabel: `${fmt2$1(v.hours)}h`,
		moneyLabel: `$${v.earnings.toFixed(2)}`
	}));
}
function shiftsInRange(shifts, startISO, endISO) {
	return shifts.filter((s) => s.date >= startISO && s.date <= endISO);
}
function sumHours(shifts) {
	return Math.round(shifts.reduce((a, s) => a + computeHours(s.signIn, s.signOut), 0) * 1e6) / 1e6;
}
/**
...
*/
function buildWeeklyHistory(allShifts, today, weekStartsOn, rate, count, signupDate) {
...
function buildChartSource(history, currentHours, currentEarnings) {
	return [...history, {
		startISO: "current",
		label: "This week",
		short: "Now",
...
function buildChart(chartSource, metric, currency) {
	...
	return {
		...
		areaPath: points.length ? `M${points[0].x},${chartH} ${points.map((p) => `L${p.x},${p.y}`).join(" ")} L${points[points.length - 1].x},${chartH} Z` : ""
	};
}
function buildBars(items, metric, currency) {
...
function buildMonthlyItems(allShifts, today, rate, count) {
	const items = [];
	for (let i = count - 1; i >= 0; i--) {
		const d = new Date(today.getFullYear(), today.getMonth() - i, 1);
		const start = isoDate(new Date(d.getFullYear(), d.getMonth(), 1));
		const hours = sumHours(shiftsInRange(allShifts, start, isoDate(new Date(d.getFullYear(), d.getMonth() + 1, 0))));
		items.push({
			startISO: start,
...
function buildYearlyItems(allShifts, today, rate, count) {
	const items = [];
	for (let i = count - 1; i >= 0; i--) {
		const year = today.getFullYear() - i;
		const start = `${year}-01-01`;
		const hours = sumHours(shiftsInRange(allShifts, start, `${year}-12-31`));
		items.push({
			startISO: start,
...
//#endregion
//#region src/lib/useTodayShift.ts
function useTodayShift() {
	...
	const start = async () => {
		await createShift({
			date: todayISO,
			location: user?.workLocationName || "",
			signIn: nowHHMMSS(),
			signOut: null
		});
	};
	const end = async () => {
		if (last && !last.signOut) await updateShift(last.id, { signOut: nowHHMMSS() });
	};
	return {
		active,
		last,
...
//#endregion
//#region src/lib/useLiveElapsedHours.ts
/**
...
*/
function useLiveElapsedHours(active, signInHHMM) {
...
//#endregion
//#region src/lib/useShiftTimer.ts
function useShiftTimer(active, signInHHMM) {
	const [, tick] = (0, import_react.useState)(0);
	(0, import_react.useEffect)(() => {
		if (!active) return;
		const id = setInterval(() => tick((n) => n + 1), 1e3);
...
//#endregion
//#region src/components/ShiftButton.tsx
var ACTIVE_COLOR = "var(--color-accent)";
var INACTIVE_COLOR = "oklch(52% 0.13 150)";
function ShiftButton({ active, onStart, onEnd, busy }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
		...
		children: active ? "Sign out" : "Sign in"
	});
}
function ElapsedTimer({ active, signIn }) {
...
//#endregion
//#region src/screens/HomeScreen.tsx
function HomeScreen() {
	...
	const days = buildWeekDaysComputed(buildWeekDays(today, weekStartsOn), groupByDate(shifts), today, "$", rate);
	...
	if (!user) return null;
	if (!shiftsLoaded || !todayDay) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "screen-wide screen-transition",
	...
	const subline = active ? `Started at ${formatTime12(last?.signIn)} — tap to end shift.` : todayDay.hours > 0 ? `${fmt2$1(todayDay.hours)}h · \$${fmt2$1(todayDay.hours * user.rate)}` : "Tap to start your shift.";
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "home-top-grid",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "card elev-sm anim-rise",
					style: {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "week-card-top",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "week-amount count-value",
								children: ["$", fmt2$1(earningsAnim)]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "week-trend",
								style: { color: trendUp ? "var(--color-accent-700)" : "var(--color-text)" },
								children: [
									trendUp ? "▲ " : "▼ ",
									Math.abs(trendPct),
									"% vs prior week"
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Hours toward goal" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								className: "count-value",
								children: [progressPctAnim, "%"]
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "today-card-row",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "card-title today-headline",
								children: headline
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "card-body today-subline",
								children: subline
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ElapsedTimer, {
								active,
								signIn: last?.signIn ?? null
							})
						] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShiftButton, {
							active,
							onStart: handlePress,
							onEnd: handlePress,
							busy
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "stat-grid",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "card stat-tile anim-rise",
					style: { ["--i"]: 2 },
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "card-kicker",
						children: "Days logged"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "card-title stat-tile-value count-value",
						children: [daysLoggedAnim, " / 7"]
					})]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "card stat-tile anim-rise",
					style: { ["--i"]: 3 },
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "card-kicker",
						children: "Weeks on goal"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "card-title stat-tile-value-lg count-value",
						children: [
							metGoalAnim,
							" / ",
							history.length
...
//#endregion
//#region src/lib/reportData.ts
function buildWeekReportData(user, shifts, today, currency) {
	const weekDays = buildWeekDays(today, user.weekStartsOn);
	const days = buildWeekDaysComputed(weekDays, groupByDate(shifts), today, currency, user.rate);
	...
	return {
		...
		generatedOnLabel: today.toLocaleDateString("en-US", {
			month: "short",
			day: "numeric",
			year: "numeric"
		}),
		...
		avgEarningsPerDayLabel: daysLogged > 0 ? currency + fmt2$1(totalEarnings / daysLogged) : "—",
...
//#endregion
//#region src/pdf/generateReportPdf.ts
var ACCENT = "#ec3013";
var ACCENT_DARK = "#ae1800";
var ACCENT_TINT = "#ffc4b8";
var TEXT = "#201e1d";
var MUTED = "#6b6866";
var NEUTRAL_LIGHT = "#f8f4f4";
var DIVIDER = "#c9c6c5";
var DARK_AVATAR = "#444141";
...
function drawGithubMark(doc, cx, cy, r, color) {
	doc.setFillColor(color);
	doc.circle(cx - r * .55, cy - r * .5, r * .4, "F");
	doc.circle(cx + r * .55, cy - r * .5, r * .4, "F");
	doc.circle(cx, cy + r * .1, r * .78, "F");
}
/** Small drawn globe standing in for a "portfolio / website" mark. */
function drawGlobeMark(doc, cx, cy, r, color) {
	doc.setDrawColor(color);
	doc.setLineWidth(.22);
	doc.circle(cx, cy, r, "S");
	doc.ellipse(cx, cy, r * .45, r, "S");
	doc.line(cx - r, cy, cx + r, cy);
}
async function generateReportPdf(data) {
	const { jsPDF } = await __vitePreload(async () => {
		const { jsPDF } = await import("./jspdf.es.min-BV6KcQi8.js");
		return { jsPDF };
	}, __vite__mapDeps([0,1]));
	const doc = new jsPDF({
		unit: "mm",
	...
	doc.circle(19, y - 2, 5, "F");
	doc.setTextColor("#ffffff");
	doc.setFont("helvetica", "bold");
	doc.setFontSize(8.5);
	doc.text(data.employeeInitials, 19, y - .8, { align: "center" });
	doc.setTextColor(TEXT);
	doc.setFont("helvetica", "bold");
	doc.setFontSize(13);
	doc.text(data.employeeName || "—", 27, y - 2.5);
	doc.setFont("helvetica", "normal");
	doc.setFontSize(9);
	doc.setTextColor(MUTED);
	const locLine = [data.workLocationName, data.workAddress].filter(Boolean).join(" · ") || "—";
	doc.text(locLine, 27, y + 2.5);
	...
	const tiles = [
		{
			label: "TOTAL HOURS",
			value: `${fmt2$1(data.totalHours)}h`,
			color: TEXT
		},
		{
	...
	data.days.forEach((d, i) => {
		...
		doc.rect(cx - dayW * .18, barBase - barH, dayW * .36, barH, "F");
	});
	y += 27;
	data.days.forEach((d, i) => {
		const cx = marginX + i * dayW + dayW / 2;
	...
	doc.setFont("helvetica", "normal");
	doc.setFontSize(8);
	if (data.shiftRows.length) data.shiftRows.forEach((r, i) => {
		if (i % 2 === 1) {
			doc.setFillColor(NEUTRAL_LIGHT);
	...
	doc.setTextColor(ACCENT_DARK);
	doc.text(`${fmt2$1(data.totalHours)}h · ${data.currency}${data.totalEarnings.toFixed(2)}`, pageW - marginX, y, { align: "right" });
	doc.setFillColor(NEUTRAL_LIGHT);
	...
	doc.link(ghStart - .6, creditY - 3, cx - ghStart + ghLabelW + 1.2, 4, { url: "https://github.com/Ezaz-Ahmad" });
	cx += ghLabelW + 5;
	const pfStart = cx;
	...
	doc.link(pfStart - .6, creditY - 3, cx - pfStart + pfLabelW + 1.2, 4, { url: "https://ezazahmad.com" });
	const filename = `wage-report-${data.weekRangeLabel.replace(/[^a-z0-9]+/gi, "-").toLowerCase()}.pdf`;
	doc.save(filename);
}
//#endregion
//#region src/screens/EntryScreen.tsx
function EntryScreen() {
	...
	const rate = user?.rate ?? 0;
	const days = buildWeekDaysComputed(buildWeekDays(today, user?.weekStartsOn ?? "Monday"), groupByDate(shifts), today, "$", rate);
	...
	if (!user) return null;
	if (!shiftsLoaded || !todayDay) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "screen-narrow screen-transition",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h6", {
			className: "section-title",
			children: "This week's hours"
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "section-hint",
			children: "Loading your week…"
		})]
	...
	function clearPending(dateISO, tempId) {
		if (!tempId) return;
		setPending((prev) => ({
			...prev,
			[dateISO]: (prev[dateISO] ?? []).filter((id) => id !== tempId)
		}));
	}
	async function handleFieldChange(day, row, field, value) {
	...
	function handleAddShift(dateISO) {
		setPending((prev) => ({
			...prev,
			[dateISO]: [...prev[dateISO] ?? [], crypto.randomUUID()]
		}));
	}
	async function handleRemoveShift(day, row) {
		if (row.id) await removeShift(row.id);
		else clearPending(day.dateISO, row.tempId);
	}
	async function handleClearDay(day) {
		if (!window.confirm(`Clear all shifts for ${day.dayAbbr}, ${day.dateLabel}?`)) return;
		const ids = day.shifts.map((s) => s.id).filter((id) => !!id);
	...
	function handleDownloadPdf() {
		generateReportPdf(buildWeekReportData(user, shifts, today, "$"));
	}
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "section-hint",
				children: "Tap a time to set sign-in and sign-out for each day, or use the clock button for today."
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "card entry-today-card anim-rise",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "card-body entry-today-sub",
					children: active ? `Started at ${formatTime12(last?.signIn)} — tap to end shift.` : todayDay.hours > 0 ? `${fmt2$1(todayDay.hours)}h · \$${fmt2$1(todayDay.hours * user.rate)}` : "Tap to start your shift."
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ElapsedTimer, {
					active,
					signIn: last?.signIn ?? null
				})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShiftButton, {
					active,
					onStart: handleShiftPress,
					onEnd: handleShiftPress,
					busy
				})]
			}),
			days.map((day, i) => {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "day-name",
								children: day.dayAbbr
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "day-date",
								children: day.dateLabel
							})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "day-row-actions",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: `day-hours${day.hours > 0 ? "" : " is-empty"}`,
									children: day.hoursLabel
								}), dayHasContent && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									type: "button",
						...
						rowsFor(day).map((row) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "shift-row",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: row.hoursLabel
								}),
								row.canRemove && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									className: "btn btn-icon btn-ghost shift-remove",
									onClick: () => handleRemoveShift(day, row),
									children: "×"
								})
							]
						}, `${day.dateISO}-${row.id ?? row.tempId ?? "placeholder"}`)),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							className: "btn btn-ghost add-shift-btn",
							onClick: () => handleAddShift(day.dateISO),
							children: "+ Add another shift"
						})
					]
				}, day.dateISO);
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "card elev-sm week-total-card anim-rise",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "week-total-row",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Total this week" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
						className: "count-value",
...
//#endregion
//#region src/screens/ReportScreen.tsx
function ReportScreen() {
	const { today, user, shifts, shiftsLoaded } = useApp();
	const [metric, setMetric] = (0, import_react.useState)("earnings");
	...
	const goalEarnings = user?.goalEarnings ?? 0;
	const createdAt = user?.createdAt ?? today.toISOString();
	const { hours: totalHours, earnings: totalEarnings } = weekTotals(buildWeekDaysComputed(buildWeekDays(today, weekStartsOn), groupByDate(shifts), today, "$", rate), rate);
	const history = buildWeeklyHistory(shifts, today, weekStartsOn, rate, 7, new Date(createdAt));
	const chartSource = buildChartSource(history, totalHours, totalEarnings);
	const chart = buildChart(chartSource, metric, "$");
	const progressPct = goalHours > 0 ? Math.min(100, Math.round(totalHours / goalHours * 100)) : 0;
	...
	const periodBars = buildBars(period === "month" ? buildMonthlyItems(shifts, today, rate, 6) : period === "year" ? buildYearlyItems(shifts, today, rate, 2) : chartSource, metric, "$");
	if (!user) return null;
	if (!shiftsLoaded) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "screen-wide screen-transition",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h6", {
			className: "section-title",
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h6", {
					...
					onClick: handleDownloadPdf,
					style: { flex: "none" },
					children: "Download this week (PDF)"
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "section-hint",
				children: "Last 7 weeks plus this week in progress."
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "seg",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
				...
				children: [
					...
					chart.points.map((p, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("g", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: chart.points.map((p, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "progress-label-row",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Hours vs. goal" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
						className: "count-value",
						children: [progressPctAnim, "%"]
					})]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					className: "progress-label-row",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Earnings vs. goal" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
						className: "count-value",
						children: [earningsProgressPctAnim, "%"]
					})]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "progress-track",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "progress-fill",
						style: { width: `${earningsProgressPct}%` }
					})
				})] })]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "card consistency-card anim-rise",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "card-kicker",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "card-title consistency-value count-value",
						children: [
							metGoalAnim,
							" of ",
							history.length,
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "hr compare-hr" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "row-baseline",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "section-hint",
				children: "See how you're doing week over week, month over month, or year over year."
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "seg",
				style: { marginBottom: "var(--space-4)" },
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "period-bars",
				children: periodBars.map((b, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "period-bar-col",
					style: { ["--i"]: i },
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "period-bar-label",
							children: b.valueLabel
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
//#endregion
//#region src/screens/HistoryScreen.tsx
function HistoryScreen() {
	...
	if (!shiftsLoaded) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h6", {
			...
			className: "section-hint",
			children: "Loading your history…"
		})]
	});
	const rows = buildWeeklyHistory(shifts, today, user.weekStartsOn, user.rate, 20, new Date(user.createdAt)).slice().reverse().map((w) => {
		const met = w.earnings >= user.goalEarnings;
		return {
			label: w.label,
			hoursLabel: `${fmt2$1(w.hours)}h`,
			earningsLabel: "$" + fmt2$1(w.earnings),
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "section-hint",
				children: "Completed weeks, most recent first."
			}),
			rows.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "card-body",
					style: { margin: 0 },
					children: "No completed weeks yet — your first full week will show up here once it ends."
				})
			}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
				className: "table",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Week" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Hours" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Earnings" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Status" })
				] }) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: rows.map((w, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
					style: { ["--i"]: i },
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: w.label }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: w.hoursLabel }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: w.earningsLabel }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: `tag ${w.tagClass}`,
							children: w.tagLabel
						}) })
					]
				}, i)) })]
...
//#endregion
//#region src/screens/SettingsScreen.tsx
function SettingsScreen() {
	const { user, updateSettings, logout, deleteAccount } = useApp();
	const [name, setName] = (0, import_react.useState)(user?.name ?? "");
	const [weekStartsOn, setWeekStartsOn] = (0, import_react.useState)(user?.weekStartsOn ?? "Monday");
	const [workLocationName, setWorkLocationName] = (0, import_react.useState)(user?.workLocationName ?? "");
	const [workAddress, setWorkAddress] = (0, import_react.useState)(user?.workAddress ?? "");
	const [multipleLocations, setMultipleLocations] = (0, import_react.useState)(user?.multipleLocations ?? false);
	const [otherLocations, setOtherLocations] = (0, import_react.useState)(user?.otherLocations ?? "");
	const [rate, setRate] = (0, import_react.useState)(user?.rate ?? 0);
	const [goalHours, setGoalHours] = (0, import_react.useState)(user?.goalHours ?? 0);
	const [goalEarnings, setGoalEarnings] = (0, import_react.useState)(user?.goalEarnings ?? 0);
	const [saving, setSaving] = (0, import_react.useState)(false);
	const [saveFlash, setSaveFlash] = (0, import_react.useState)(false);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "section-hint",
				style: { marginBottom: "var(--space-4)" },
				children: "Your rate, weekly goals and preferences."
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "field field-spaced",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { children: "Your name" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
					className: "input",
					type: "text",
					value: name,
					onChange: (e) => setName(e.target.value)
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "field field-spaced",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { children: "Week starts on" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "seg",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
						className: "seg-opt",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "field field-spaced",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { children: "Weekly hours goal" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
					className: "input",
					type: "number",
					step: .5,
					min: 0,
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				...
				style: { marginBottom: "var(--space-4)" },
				children: "Set goal = rate × hour goal"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "hr" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				...
				onClick: handleSave,
				disabled: saving,
				children: saveFlash ? "Saved ✓" : saving ? "Saving…" : "Save settings"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: "Time entries and reports are kept for 5 years and automatically deleted after that."
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppCredit, {}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "hr" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h6", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "section-hint",
				children: "Permanently delete your account and every shift you've logged. This can't be undone."
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
			...
			showDeleteDialog && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: "This permanently deletes your account, settings, and all logged shifts. There's no way to undo this. Enter your password to confirm."
						}),
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { children: "Password" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PasswordInput, {
								...
								onKeyDown: (e) => {
									if (e.key === "Enter" && deletePassword && !deleting) handleDeleteAccount();
								}
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							className: "app-nav-greeting",
							children: ["Welcome back", user ? `, ${user.name.split(" ")[0]}` : ""]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "app-nav-date",
							children: todayLabel
						})
					]
				}),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							screen === "entry" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EntryScreen, {}),
							screen === "report" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ReportScreen, {}),
...
function Root() {
	...
	return status === "loggedIn" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AuthedApp, {}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AuthScreen, {});
}
function App() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Root, {}) });
}
//#endregion
//#region src/admin/adminApi.ts
var API_ORIGIN = "".replace(/\/+$/, "");
var ADMIN_TOKEN_KEY = "wageTracker.adminToken";
...
async function request(path, options = {}) {
	...
	if (res.status === 204) return void 0;
	const body = await res.json().catch(() => ({}));
	if (!res.ok) throw new AdminApiError(body.error || `Request failed (${res.status})`, res.status);
	return body;
}
...
//#endregion
//#region src/admin/AdminLogin.tsx
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h6", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Logo, { size: 20 }), "Wage Tracker — Admin"]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "field field-spaced",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { children: "Admin password" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PasswordInput, {
									placeholder: "••••••••",
									autoFocus: true,
									value: password,
									onChange: (e) => setPassword(e.target.value),
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "auth-demo-note",
						children: "Not a regular account — a separate admin-only password."
					})
				]
			})
		})
...
//#endregion
//#region src/admin/AdminDashboard.tsx
var CURRENCY = "$";
function fmt2(n) {
	return (Math.round(n * 100) / 100).toFixed(2);
}
...
function AdminDashboard({ onLogout, onAuthError }) {
	...
	const [detailLoadingId, setDetailLoadingId] = (0, import_react.useState)(null);
	...
	const totalShifts = (0, import_react.useMemo)(() => (users ?? []).reduce((a, u) => a + u.shiftCount, 0), [users]);
	async function handleView(u) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "admin-frame screen-transition",
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "card-kicker",
								children: "Total shifts logged"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "card-title stat-tile-value-lg count-value",
								children: users ? totalShifts : "—"
							})]
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "row-baseline admin-toolbar",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h6", {
							className: "section-title",
							style: { margin: 0 },
							children: "All users"
					...
					users === null && !loadError ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "section-hint",
						children: "Loading…"
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "card-body",
							style: { margin: 0 },
							children: users && users.length > 0 ? "No users match your search." : "No users yet."
						})
					}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Work location" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Rate" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Goals" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Shifts" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Joined" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", {})
							] }) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: filtered.map((u, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
								style: { ["--i"]: i },
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: u.name }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: u.email }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: u.workLocationName || "—" }),
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: u.shiftCount }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: fmtDate(u.createdAt) }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
										className: "admin-row-actions",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
											className: "btn btn-ghost",
											onClick: () => handleView(u),
											disabled: detailLoadingId === u.id,
											children: detailLoadingId === u.id ? "Loading…" : "View"
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
											className: "btn btn-danger",
			...
			detail && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "dialog admin-detail-dialog",
					onClick: (e) => e.stopPropagation(),
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "dialog-title",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							...
							children: [
								detail.user.email,
								" · ",
								detail.user.workLocationName || "No work location set",
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
								CURRENCY,
								fmt2(detail.user.rate),
								"/hr · goal ",
								detail.user.goalHours,
								"h · ",
								CURRENCY,
								fmt2(detail.user.goalEarnings),
								"/week · week starts ",
								detail.user.weekStartsOn
							]
						}),
						detailError && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "form-error",
							children: detailError
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "admin-detail-shifts",
							children: detail.shifts.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "card-body",
								children: "No shifts logged."
							}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
								className: "table",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Date" }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Location" }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Sign in" }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Sign out" })
								] }) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: detail.shifts.map((s) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: s.date }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: s.location || "—" }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: s.signIn ?? "—" }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: s.signOut ?? "—" })
								] }, s.id)) })]
							})
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			deleteTarget && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "dialog-backdrop",
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "dialog-body",
							children: [
								"This permanently deletes this user's account and all ",
								deleteTarget.shiftCount,
								" logged shift",
								deleteTarget.shiftCount === 1 ? "" : "s",
								". There's no way to undo this. Type",
								" ",
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: deleteTarget.email }),
								" to confirm."
							]
						}),
						deleteError && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "field",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { children: "Confirm email" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
								className: "input",
								type: "text",
								autoFocus: true,
...
//#endregion
//#region src/admin/AdminApp.tsx
function AdminApp() {
	const [token, setTokenState] = (0, import_react.useState)(() => getAdminToken());
	const handleLoggedIn = (0, import_react.useCallback)((t) => {
		setAdminToken(t);
		setTokenState(t);
	}, []);
	...
	const handleAuthError = (0, import_react.useCallback)((e) => {
	...
	if (!token) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AdminLogin, { onLoggedIn: handleLoggedIn });
		...
		if (this.state.error) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "card-body",
						children: "The app hit an unexpected error. Try reloading — if it keeps happening, your data is safe on the server."
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
...
(0, import_client.createRoot)(document.getElementById("root")).render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react.StrictMode, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ErrorBoundary, { children: isAdminRoute ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AdminApp, {}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(App, {}) }) }));
//#endregion
export { __commonJSMin as n, __toESM as r, __vitePreload as t };
