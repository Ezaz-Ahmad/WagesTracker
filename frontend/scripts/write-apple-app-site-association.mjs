...
if (configured) {
  ...
  console.warn(
    "[universal-links] APPLE_TEAM_ID is unset. Password-reset and email-change verification links still work in the responsive web page, but will not open the installed iPhone app directly."
  );
}
